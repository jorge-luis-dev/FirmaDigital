...
public class XAdESBESSignature extends GenericXMLSignature {
    ...
    public static void setRESOURCE_TO_SIGN(String RESOURCE_TO_SIGN) {
        XAdESBESSignature.RESOURCE_TO_SIGN = RESOURCE_TO_SIGN;
    }

    public static void setSIGN_FILE_NAME(String SIGN_FILE_NAME) {
        XAdESBESSignature.SIGN_FILE_NAME = SIGN_FILE_NAME;
    }
    ...
    */
     ...
     * @return 
     */
    public static boolean firmar(String urlArchivo,String nombreArchivo,String urlOutArchivo) {
        XAdESBESSignature signature = new XAdESBESSignature();
        RESOURCE_TO_SIGN=urlArchivo;
        SIGN_FILE_NAME=nombreArchivo;
